...
/// Returns the output frequencies of the PLL clocks based on reading the registers.
fn pll_status(
    running: bool,
    hoco: HertzU32,
...
/// Returns and validates the intended PLL clock frequencies based on the `PllConfig` and `ClockConfig` structs.
/// Panics if any of the frequencies are out of range.
