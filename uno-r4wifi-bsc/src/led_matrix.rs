...
impl<'d> LedMatrix {
    ...
    pub fn new(
        ...
        let pins = unsafe {
            [
                AnyPin::steal(d0.pin_port()),
                AnyPin::steal(d1.pin_port()),
                AnyPin::steal(d2.pin_port()),
                AnyPin::steal(d3.pin_port()),
                AnyPin::steal(d4.pin_port()),
                AnyPin::steal(d5.pin_port()),
                AnyPin::steal(d6.pin_port()),
                AnyPin::steal(d7.pin_port()),
                AnyPin::steal(d8.pin_port()),
                AnyPin::steal(d9.pin_port()),
                AnyPin::steal(d10.pin_port()),
            ]
        };
