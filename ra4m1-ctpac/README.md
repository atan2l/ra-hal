...
Unlike similar PACs for the RA4M1 that utilize `svd2rust`, this crate is generated programmatically by [chiptool](https://github.com/embassy-rs/chiptool) using the SVD as found on Keil's [site](https://www.keil.arm.com/packs/ra_dfp-renesas/versions/).
...
The user manual is available online from Renesas and is document number R01UH0887.

Some peripherals have been merged to reduce code bloat.
This crate does not prevent access to features that may be missing in the underlying hardware.
Read the user manual before using this crate directly.
