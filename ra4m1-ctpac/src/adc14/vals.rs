...
impl AdcCountSelect {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> AdcCountSelect {
...
impl From<u8> for AdcCountSelect {
    #[inline(always)]
    fn from(val: u8) -> AdcCountSelect {
        AdcCountSelect::from_bits(val)
    }
}
impl From<AdcCountSelect> for u8 {
    #[inline(always)]
    fn from(val: AdcCountSelect) -> u8 {
        AdcCountSelect::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
