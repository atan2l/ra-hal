...
impl defmt::Format for Dccr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Dccr {{ dcmf: {:?}, reserved: {=u8:?}, dper: {:?}, dfer: {:?}, reserved_2: {=bool:?}, idsel: {:?}, dcme: {:?} }}",
            self.dcmf(),
            self.reserved(),
            self.dper(),
            self.dfer(),
...
impl defmt::Format for Fcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Fcr {{ fm: {:?}, rfrst: {:?}, tfrst: {:?}, dres: {:?}, ttrg: {:?}, rtrg: {:?}, rstrg: {:?} }}",
            self.fm(),
            self.rfrst(),
            self.tfrst(),
            self.dres(),
...
impl defmt::Format for Frdrh {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Frdrh {{ rdath: {=bool:?}, mpb: {:?}, dr: {:?}, per: {:?}, fer: {:?}, orer: {:?}, rdf: {:?}, reserved: {=bool:?} }}",
            self.rdath(),
            self.mpb(),
            self.dr(),
            self.per(),
...
impl defmt::Format for Frdrhl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Frdrhl {{ rdat: {=u16:?}, mpb: {:?}, dr: {:?}, per: {:?}, fer: {:?}, orer: {:?}, rdf: {:?}, reserved: {=bool:?} }}",
            self.rdat(),
            self.mpb(),
            self.dr(),
            self.per(),
...
impl defmt::Format for Ftdrh {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ftdrh {{ tdath: {=bool:?}, mpbt: {:?}, reserved: {=u8:?} }}",
            self.tdath(),
            self.mpbt(),
            self.reserved()
        )
...
impl defmt::Format for Ftdrhl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ftdrhl {{ tdat: {=u16:?}, mpbt: {:?}, reserved: {=u8:?} }}",
            self.tdat(),
            self.mpbt(),
            self.reserved()
        )
...
impl defmt::Format for Lsr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Lsr {{ orer: {:?}, reserved: {=bool:?}, fnum: {=u8:?}, reserved_2: {=bool:?}, pnum: {=u8:?}, reserved_3: {=u8:?} }}",
            self.orer(),
            self.reserved(),
            self.fnum(),
            self.reserved_2(),
...
impl defmt::Format for Scmr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Scmr {{ smif: {:?}, reserved: {=bool:?}, sinv: {:?}, sdir: {:?}, chr1: {:?}, reserved_2: {=u8:?}, bcp2: {:?} }}",
            self.smif(),
            self.reserved(),
            self.sinv(),
            self.sdir(),
...
impl defmt::Format for ScrSmci {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "ScrSmci {{ cke: {:?}, teie: {=bool:?}, mpie: {=bool:?}, re: {:?}, te: {:?}, rie: {:?}, tie: {:?} }}",
            self.cke(),
            self.teie(),
            self.mpie(),
            self.re(),
...
impl defmt::Format for Semr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Semr {{ reserved: {=u8:?}, brme: {:?}, abcse: {:?}, abcs: {:?}, nfen: {:?}, bgdm: {:?}, rxdesel: {:?} }}",
            self.reserved(),
            self.brme(),
            self.abcse(),
            self.abcs(),
...
impl defmt::Format for Simr2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Simr2 {{ iicintm: {:?}, iiccsc: {:?}, reserved: {=u8:?}, iicackt: {:?}, reserved_2: {=u8:?} }}",
            self.iicintm(),
            self.iiccsc(),
            self.reserved(),
            self.iicackt(),
...
impl defmt::Format for Simr3 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Simr3 {{ iicstareq: {:?}, iicrstareq: {:?}, iicstpreq: {:?}, iicstif: {:?}, iicsdas: {:?}, iicscls: {:?} }}",
            self.iicstareq(),
            self.iicrstareq(),
            self.iicstpreq(),
            self.iicstif(),
...
impl defmt::Format for Sisr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Sisr {{ iicackr: {:?}, reserved: {=bool:?}, reserved_2: {=bool:?}, reserved_3: {=bool:?}, reserved_4: {=bool:?}, reserved_5: {=bool:?}, reserved_6: {=u8:?} }}",
            self.iicackr(),
            self.reserved(),
            self.reserved_2(),
            self.reserved_3(),
...
impl defmt::Format for Spmr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Spmr {{ sse: {:?}, ctse: {:?}, mss: {:?}, reserved: {=bool:?}, mff: {:?}, reserved_2: {=bool:?}, ckpol: {:?}, ckph: {:?} }}",
            self.sse(),
            self.ctse(),
            self.mss(),
            self.reserved(),
...
impl defmt::Format for Sptr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Sptr {{ rxdmon: {:?}, spb2dt: {:?}, spb2io: {:?}, reserved: {=u8:?} }}",
            self.rxdmon(),
            self.spb2dt(),
            self.spb2io(),
            self.reserved()
...
impl defmt::Format for Ssr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ssr {{ mpbt: {:?}, mpb: {:?}, tend: {:?}, per: {:?}, fer: {:?}, orer: {:?}, rdrf: {:?}, tdre: {:?} }}",
            self.mpbt(),
            self.mpb(),
            self.tend(),
            self.per(),
...
impl defmt::Format for SsrFifo {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SsrFifo {{ dr: {:?}, reserved: {=bool:?}, tend: {:?}, per: {:?}, fer: {:?}, orer: {:?}, rdf: {:?}, tdfe: {:?} }}",
            self.dr(),
            self.reserved(),
            self.tend(),
            self.per(),
...
impl defmt::Format for SsrSmci {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SsrSmci {{ mpbt: {=bool:?}, mpb: {=bool:?}, tend: {:?}, per: {:?}, ers: {:?}, orer: {:?}, rdrf: {:?}, tdre: {:?} }}",
            self.mpbt(),
            self.mpb(),
            self.tend(),
            self.per(),
