...
unsafe impl Send for Iic {}
unsafe impl Sync for Iic {}
impl Iic {
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn iccr1(self) -> crate::common::Reg<super::iic0::regs::Iccr1, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "I2C Bus Control Register 2"]
    #[inline(always)]
    pub const fn iccr2(self) -> crate::common::Reg<super::iic0::regs::Iccr2, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x01usize) as _) }
    }
    #[doc = "I2C Bus Mode Register 1"]
    #[inline(always)]
    pub const fn icmr1(self) -> crate::common::Reg<super::iic0::regs::Icmr1, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x02usize) as _) }
    }
    #[doc = "I2C Bus Mode Register 2"]
    #[inline(always)]
    pub const fn icmr2(self) -> crate::common::Reg<super::iic0::regs::Icmr2, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x03usize) as _) }
    }
    #[doc = "I2C Bus Mode Register 3"]
    #[inline(always)]
    pub const fn icmr3(self) -> crate::common::Reg<super::iic0::regs::Icmr3, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "I2C Bus Function Enable Register"]
    #[inline(always)]
    pub const fn icfer(self) -> crate::common::Reg<super::iic0::regs::Icfer, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x05usize) as _) }
    }
    #[doc = "I2C Bus Status Enable Register"]
    #[inline(always)]
    pub const fn icser(self) -> crate::common::Reg<super::iic0::regs::Icser, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x06usize) as _) }
    }
    #[doc = "I2C Bus Interrupt Enable Register"]
    #[inline(always)]
    pub const fn icier(self) -> crate::common::Reg<super::iic0::regs::Icier, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x07usize) as _) }
    }
    #[doc = "I2C Bus Status Register 1"]
    #[inline(always)]
    pub const fn icsr1(self) -> crate::common::Reg<super::iic0::regs::Icsr1, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize) as _) }
    }
    #[doc = "I2C Bus Status Register 2"]
    #[inline(always)]
    pub const fn icsr2(self) -> crate::common::Reg<super::iic0::regs::Icsr2, crate::common::RW> {
    ...
    pub const fn sarl(
        self,
        n: usize,
    ) -> crate::common::Reg<super::iic0::regs::Sarl, crate::common::RW> {
        assert!(n < 3usize);
