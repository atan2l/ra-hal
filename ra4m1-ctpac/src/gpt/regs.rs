...
impl Gtber {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ccra(&self) -> super::vals::Ccr {
        let val = (self.0 >> 16usize) & 0x03;
        super::vals::Ccr::from_bits(val as u8)
    }
    #[doc = "GTCCRA Buffer Operation"]
    #[inline(always)]
    pub const fn set_ccra(&mut self, val: super::vals::Ccr) {
        self.0 = (self.0 & !(0x03 << 16usize)) | (((val.to_bits() as u32) & 0x03) << 16usize);
    }
    #[doc = "GTCCRB Buffer Operation"]
    #[must_use]
    #[inline(always)]
    pub const fn ccrb(&self) -> super::vals::Ccr {
        let val = (self.0 >> 18usize) & 0x03;
        super::vals::Ccr::from_bits(val as u8)
    }
    #[doc = "GTCCRB Buffer Operation"]
    #[inline(always)]
    pub const fn set_ccrb(&mut self, val: super::vals::Ccr) {
...
impl Gtior {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn gtioa(&self) -> super::vals::Gtio {
        let val = (self.0 >> 0usize) & 0x1f;
        super::vals::Gtio::from_bits(val as u8)
    }
    #[doc = "GTIOCA Pin Function Select"]
    #[inline(always)]
    pub const fn set_gtioa(&mut self, val: super::vals::Gtio) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn gtiob(&self) -> super::vals::Gtio {
        let val = (self.0 >> 16usize) & 0x1f;
        super::vals::Gtio::from_bits(val as u8)
    }
    #[doc = "GTIOCB Pin Function Select"]
    #[inline(always)]
    pub const fn set_gtiob(&mut self, val: super::vals::Gtio) {
