...
#![no_std]
#![doc = "Peripheral access API (generated using chiptool v0.1.0 (9e37a92 2026-02-01))"]
...
pub const PORT0: port::Port = unsafe { port::Port::from_ptr(0x4004_0000usize as _) };
#[doc = "Port 1 Control Registers"]
pub const PORT1: port::Port = unsafe { port::Port::from_ptr(0x4004_0020usize as _) };
#[doc = "Port 2 Control Registers"]
pub const PORT2: port::Port = unsafe { port::Port::from_ptr(0x4004_0040usize as _) };
#[doc = "Port 3 Control Registers"]
pub const PORT3: port::Port = unsafe { port::Port::from_ptr(0x4004_0060usize as _) };
#[doc = "Port 4 Control Registers"]
pub const PORT4: port::Port = unsafe { port::Port::from_ptr(0x4004_0080usize as _) };
#[doc = "Port 5 Control Registers"]
pub const PORT5: port::Port = unsafe { port::Port::from_ptr(0x4004_00a0usize as _) };
#[doc = "Port 6 Control Registers"]
pub const PORT6: port::Port = unsafe { port::Port::from_ptr(0x4004_00c0usize as _) };
#[doc = "Port 7 Control Registers"]
pub const PORT7: port::Port = unsafe { port::Port::from_ptr(0x4004_00e0usize as _) };
#[doc = "Port 8 Control Registers"]
pub const PORT8: port::Port = unsafe { port::Port::from_ptr(0x4004_0100usize as _) };
#[doc = "Port 9 Control Registers"]
pub const PORT9: port::Port = unsafe { port::Port::from_ptr(0x4004_0120usize as _) };
...
pub const GPT32_0: gpt::Gpt = unsafe { gpt::Gpt::from_ptr(0x4007_8000usize as _) };
#[doc = "General PWM Timer 1 (32-bit)"]
pub const GPT32_1: gpt::Gpt = unsafe { gpt::Gpt::from_ptr(0x4007_8100usize as _) };
#[doc = "General PWM Timer 2 (16-bit)"]
pub const GPT16_2: gpt::Gpt = unsafe { gpt::Gpt::from_ptr(0x4007_8200usize as _) };
#[doc = "General PWM Timer 3 (16-bit)"]
pub const GPT16_3: gpt::Gpt = unsafe { gpt::Gpt::from_ptr(0x4007_8300usize as _) };
#[doc = "General PWM Timer 4 (16-bit)"]
pub const GPT16_4: gpt::Gpt = unsafe { gpt::Gpt::from_ptr(0x4007_8400usize as _) };
#[doc = "General PWM Timer 5 (16-bit)"]
pub const GPT16_5: gpt::Gpt = unsafe { gpt::Gpt::from_ptr(0x4007_8500usize as _) };
#[doc = "General PWM Timer 6 (16-bit)"]
pub const GPT16_6: gpt::Gpt = unsafe { gpt::Gpt::from_ptr(0x4007_8600usize as _) };
#[doc = "General PWM Timer 7 (16-bit)"]
pub const GPT16_7: gpt::Gpt = unsafe { gpt::Gpt::from_ptr(0x4007_8700usize as _) };
