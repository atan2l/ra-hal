...
impl Adc14 {
    ...
    #[doc = "A/D Channel Select Registers A0 and A1"]
    #[inline(always)]
    pub const fn adansa(self, n: usize) -> crate::common::Reg<regs::Adans, crate::common::RW> {
        assert!(n < 2usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize + n * 2usize) as _) }
    }
    #[doc = "A/D-Converted Value Addition/Average Channel Select Registers 0 and 1"]
    #[inline(always)]
    pub const fn adads(self, n: usize) -> crate::common::Reg<regs::Adads, crate::common::RW> {
        assert!(n < 2usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize + n * 2usize) as _) }
    }
    ...
    #[doc = "A/D Channel Select Registers B0 and B1"]
    #[inline(always)]
    pub const fn adansb(self, n: usize) -> crate::common::Reg<regs::Adans, crate::common::RW> {
        assert!(n < 2usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x14usize + n * 2usize) as _) }
    }
    ...
    #[doc = "A/D Data Register n"]
    #[inline(always)]
    pub const fn addr(self, n: usize) -> crate::common::Reg<u16, crate::common::RW> {
        assert!(n < 32usize);
    ...
    #[doc = "A/D Sampling State Register L (AN016..=AN025)"]
    #[inline(always)]
    ...
    #[doc = "A/D Sampling State Register T (temperature sensor)"]
    #[inline(always)]
    ...
    #[doc = "A/D Sampling State Register O (Vref)"]
    #[inline(always)]
    ...
    #[doc = "A/D Sampling State Register (AN000..=AN0014)"]
    #[inline(always)]
